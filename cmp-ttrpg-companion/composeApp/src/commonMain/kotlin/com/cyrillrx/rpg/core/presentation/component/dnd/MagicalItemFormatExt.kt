...
fun MagicalItem.Type.toStringRes(): StringResource = when (this) {
...
@Composable
fun MagicalItem.Type.toFormattedString(): String = stringResource(toStringRes())
...
@Composable
fun MagicalItem.getSubtitle(): String = type.toFormattedString() + SUBTITLE_SEPARATOR + rarity.toFormattedString()
