...
import rpg_companion.composeapp.generated.resources.creature_alignment_any_alignment
...
fun Creature.Alignment.toFormattedString(): String {
    val stringRes = when (this) {
        ...
        Creature.Alignment.UNALIGNED -> Res.string.creature_alignment_unaligned
        Creature.Alignment.ANY_ALIGNMENT -> Res.string.creature_alignment_any_alignment
